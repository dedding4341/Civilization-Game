...
public class Map {
     ...
     *once there are more than size rows or size columns, as it expects each row
    ...
    private void populateMap() {
        ...
        for (int r = 0; r < size; r++) {
            TileType[] row = new TileType[size];
