...
class Civilization {
    ...
    private boolean beenBoosted;

    public boolean getBeenBoosted() {
        return beenBoosted;
    }

    public void setBeenBoosted(boolean setThis) {
        this.beenBoosted = setThis;
    }
    ...
    public void setResources(int setThis) {
        this.resources = setThis;
    }

    public void setFood(int setThis) {
        this.food = setThis;
    }
